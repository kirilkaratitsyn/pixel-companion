...
(async()=>{
 ...
 try{
  ...
  const state={type:'state',version:1,computer:'Тестовый ПК',locked:false,timestamp:Date.now(),selectedSource:null,sources:[{id:'test',name:'Тестовый плеер'}],volume:.35,mixer:[{id:'chrome',name:'Google Chrome',volume:.72,muted:false,active:true},{id:'discord',name:'Discord',volume:.4,muted:false,active:false}],shortcuts:[{id:'discord',name:'Discord',kind:'app'},{id:'youtube-music',name:'YouTube Music',kind:'music'},{id:'spotify',name:'Spotify',kind:'music'}],error:null,media:{sessionId:'test-session',revision:1,source:'Тестовый плеер',title:'Тихий свет',artist:'Тест интерфейса',status:'playing',position:84,duration:222,rate:1,artworkHash:null,controls:{play:true,pause:true,toggle:true,previous:true,next:true,seek:true}}};
